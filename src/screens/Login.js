...
const Login = ({
  ...
  const handleLogin = () => {
    try{
      ...
      /**
       * O estado de auth estára preenchido. 
       * Ai vc vai terque validar la nas rotas de alguma forma se estiver id preenchido,
       * joga pra home como rota "padrão"
       */
    }catch(err) {
      /**
       * COLOCA UMA MENSAGEM DE ERRO AQUI
       */
    }
  }
